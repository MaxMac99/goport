...
type CpuStatsCpuUsage struct {
	TotalUsage int32 `json:"TotalUsage,omitempty"`

	PercpuUsage []int32 `json:"PercpuUsage,omitempty"`

	UsageInKernelMode int32 `json:"UsageInKernelMode,omitempty"`

	UsageInUserMode int32 `json:"UsageInUserMode,omitempty"`
}
