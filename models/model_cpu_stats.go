...
type CpuStats struct {
	CPUUsage CpuStatsCpuUsage `json:"CPUUsage,omitempty"`

	SystemUsage int32 `json:"SystemUsage,omitempty"`

	OnlineCPUs int32 `json:"OnlineCPUs,omitempty"`

	ThrottlingData CpuStatsThrottlingData `json:"ThrottlingData,omitempty"`
}
